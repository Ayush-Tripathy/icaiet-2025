...
const Registration = () => {
  return (
    <div className="pt-32 bg-black text-white flex flex-col gap-10 min-h-screen px-3 sm:px-10 lg:px-20 py-10">
        ...
        <Table className="text-white font-[SatoshiRegular] text-lg">
          <TableHeader>
            <TableRow className="hover:bg-inherit border-[#2e2e2e]">
              <TableHead className="whitespace-nowrap">SI. No.</TableHead>
        ...
        <Table className="text-white font-[SatoshiRegular] text-lg">
          ...
          <TableBody>
            ...
            <TableRow className="hover:bg-inherit border-[#2e2e2e]">
              ...
              <TableCell className="">150$</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </div>
      ...
      <div className="border border-[#2e2e2e] rounded-lg w-fit">
        <Table className="text-white font-[SatoshiRegular] text-lg">
          <TableBody>
            <TableRow className="hover:bg-inherit border-[#2e2e2e]">
