...
export default function Home() {
  ...
  return (
    <div>
      <header className="sticky top-0 z-50 w-full border-b bg-[#0a0b1a] text-white">
        <div className="container flex h-16 items-center">
          ...
          <nav className="ml-auto relative">
            <ul className="flex space-x-4">
              {[
                { name: "Agenda", items: ["How to get & Venue", "App & Matchmaking", "Side Events"] },
                ...
                >
                  ...
                  >
                    {menu.name}
                    <ChevronDown className={`ml-1 h-4 w-4 transition-transform duration-200 ${activeDropdown === menu.name ? 'rotate-180' : ''}`} />
                  </a>
